...
from enterprise_dp.pipelines.base import PipelineRunRequest, PipelineRunner, PipelineSpec
from enterprise_dp.pipelines.billing import BillingRevenueDailyRunner
from enterprise_dp.pipelines.control_tower import ControlTowerGoldMaterializationRunner
from enterprise_dp.pipelines.customer import CustomerAccountHealthRunner
from enterprise_dp.pipelines.finance import FinanceBenefitReconciliationRunner
from enterprise_dp.pipelines.identity_access import IdentityAccessGovernanceRunner
from enterprise_dp.pipelines.lms_recommendation import LmsRecommendationTrainingRunner
from enterprise_dp.pipelines.recommendation import RecommendationFromBronzeRunner, RecommendationRawJsonlRunner
from enterprise_dp.pipelines.scorecard import ExecutiveScorecardRunner
from enterprise_dp.pipelines.support import SupportSlaRunner
...
def default_pipeline_registry() -> PipelineRegistry:
    ...
    registry.register(LmsRecommendationTrainingRunner())
