...
- Topic changes must run `enterprise-dp contract-impact-report`; a compatible schema can still
  require owner review when downstream P0 use cases, Gold products or active grants are affected.
