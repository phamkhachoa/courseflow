...
operational read-model service. A flat `dp/` folder would also become hard to scale as domains and
pipelines grow.

## Decision

Create `dp/` as a top-level workspace and organize it into:
...
- `src/enterprise_dp/` for platform developer tooling.
