...
The group should build `dp/` as a shared enterprise data platform, not as an LMS-only warehouse and
...
[`architecture/enterprise-data-platform-charter.md`](architecture/enterprise-data-platform-charter.md).
...
| `dp/platform/` | Shared ingestion, lakehouse, processing, orchestration, quality, governance, security, serving, observability and developer experience. |
