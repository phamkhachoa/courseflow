...
from enterprise_dp.pipelines import PipelineRegistry, PipelineRunRequest, default_pipeline_registry
from enterprise_dp.pipelines.recommendation import RecommendationFromBronzeRunner
...
def test_pipeline_registry_lists_recommendation_runners() -> None:
    ...
    assert control_tower.product == "enterprise-data-platform"
    ...
    assert scorecard.product == "enterprise-data-platform"
