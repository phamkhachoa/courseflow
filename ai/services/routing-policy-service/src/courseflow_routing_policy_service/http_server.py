...
from courseflow_routing_policy_service.service import RoutingPolicyService
...
def handler_for(service: RoutingPolicyService) -> type[BaseHTTPRequestHandler]:
    class RoutingPolicyRequestHandler(BaseHTTPRequestHandler):
        server_version = "CourseFlowRoutingPolicy/0.1"
    ...
    return RoutingPolicyRequestHandler
