...
from courseflow_governance_evaluation_service.service import GovernanceEvaluationService
...
def handler_for(
    ...
    class GovernanceEvaluationRequestHandler(BaseHTTPRequestHandler):
        server_version = "CourseFlowGovernanceEvaluation/0.1"
    ...
    return GovernanceEvaluationRequestHandler
