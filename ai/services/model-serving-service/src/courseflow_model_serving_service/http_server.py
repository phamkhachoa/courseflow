...
from courseflow_model_serving_service.service import ModelServingService
...
def handler_for(service: ModelServingService) -> type[BaseHTTPRequestHandler]:
    class ModelServingRequestHandler(BaseHTTPRequestHandler):
        server_version = "CourseFlowModelServing/0.1"
    ...
    return ModelServingRequestHandler
