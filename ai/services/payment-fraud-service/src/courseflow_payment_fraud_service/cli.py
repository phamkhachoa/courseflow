...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="CourseFlow AI Platform payment fraud service."
    )
...
def main(argv: list[str] | None = None) -> int:
    ...
    service = PaymentFraudService(
        PaymentFraudServiceConfig.from_paths(
    ...
    if args.command == "serve":
        from courseflow_payment_fraud_service.http_server import serve_http
