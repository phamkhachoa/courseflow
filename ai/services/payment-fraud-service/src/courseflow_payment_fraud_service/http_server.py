...
from courseflow_payment_fraud_service.service import PaymentFraudService
...
def handler_for(service: PaymentFraudService) -> type[BaseHTTPRequestHandler]:
    class PaymentFraudRequestHandler(BaseHTTPRequestHandler):
        server_version = "CourseFlowPaymentFraud/0.1"
    ...
    return PaymentFraudRequestHandler
