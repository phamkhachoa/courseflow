...
from courseflow_llm_adapter_service.service import LlmAdapterService
...
def handler_for(service: LlmAdapterService) -> type[BaseHTTPRequestHandler]:
    class LlmAdapterRequestHandler(BaseHTTPRequestHandler):
        server_version = "CourseFlowLlmAdapter/0.1"
    ...
    return LlmAdapterRequestHandler
