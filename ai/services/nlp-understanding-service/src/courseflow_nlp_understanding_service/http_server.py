...
from courseflow_nlp_understanding_service.service import NlpUnderstandingService
...
def handler_for(service: NlpUnderstandingService) -> type[BaseHTTPRequestHandler]:
    class NlpUnderstandingRequestHandler(BaseHTTPRequestHandler):
        server_version = "CourseFlowNlpUnderstanding/0.1"
    ...
    return NlpUnderstandingRequestHandler
