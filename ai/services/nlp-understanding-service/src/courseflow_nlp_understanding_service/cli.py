...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="CourseFlow AI Platform NLP understanding service."
    )
...
def main(argv: list[str] | None = None) -> int:
    ...
    service = NlpUnderstandingService(
        NlpUnderstandingServiceConfig.from_paths(
    ...
    if args.command == "serve":
        from courseflow_nlp_understanding_service.http_server import serve_http
