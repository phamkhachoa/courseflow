...
from courseflow_prompt_gateway_service.service import PromptGatewayService
...
def handler_for(service: PromptGatewayService) -> type[BaseHTTPRequestHandler]:
    class PromptGatewayRequestHandler(BaseHTTPRequestHandler):
        server_version = "CourseFlowPromptGateway/0.1"
    ...
    return PromptGatewayRequestHandler
