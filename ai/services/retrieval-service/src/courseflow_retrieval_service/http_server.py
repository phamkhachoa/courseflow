...
from courseflow_retrieval_service.service import RetrievalService
...
def handler_for(service: RetrievalService) -> type[BaseHTTPRequestHandler]:
    class RetrievalRequestHandler(BaseHTTPRequestHandler):
        server_version = "CourseFlowRetrieval/0.1"
