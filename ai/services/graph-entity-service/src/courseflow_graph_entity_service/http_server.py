...
from courseflow_graph_entity_service.service import GraphEntityService
...
def handler_for(service: GraphEntityService) -> type[BaseHTTPRequestHandler]:
    class GraphEntityRequestHandler(BaseHTTPRequestHandler):
        server_version = "CourseFlowGraphEntity/0.1"
    ...
    return GraphEntityRequestHandler
