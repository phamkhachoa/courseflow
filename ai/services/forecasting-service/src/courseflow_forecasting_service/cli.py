...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="CourseFlow AI Platform forecasting service."
    )
...
def main(argv: list[str] | None = None) -> int:
    ...
    service = ForecastingService(
        ForecastingServiceConfig.from_paths(
    ...
    if args.command == "serve":
        from courseflow_forecasting_service.http_server import serve_http
