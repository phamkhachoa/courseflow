...
from courseflow_forecasting_service.service import ForecastingService
...
def handler_for(service: ForecastingService) -> type[BaseHTTPRequestHandler]:
    class ForecastingRequestHandler(BaseHTTPRequestHandler):
        server_version = "CourseFlowForecasting/0.1"
    ...
    return ForecastingRequestHandler
