...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="CourseFlow AI Platform causal uplift service."
    )
...
def main(argv: list[str] | None = None) -> int:
    ...
    service = CausalUpliftService(
        CausalUpliftServiceConfig.from_paths(
    ...
    if args.command == "serve":
        from courseflow_causal_uplift_service.http_server import serve_http
