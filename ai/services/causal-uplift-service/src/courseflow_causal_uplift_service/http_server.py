...
from courseflow_causal_uplift_service.service import CausalUpliftService
...
def handler_for(service: CausalUpliftService) -> type[BaseHTTPRequestHandler]:
    class CausalUpliftRequestHandler(BaseHTTPRequestHandler):
        server_version = "CourseFlowCausalUplift/0.1"
    ...
    return CausalUpliftRequestHandler
