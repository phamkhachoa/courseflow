...
from courseflow_sequence_risk_service.service import SequenceRiskService
...
def handler_for(service: SequenceRiskService) -> type[BaseHTTPRequestHandler]:
    class SequenceRiskRequestHandler(BaseHTTPRequestHandler):
        server_version = "CourseFlowSequenceRisk/0.1"
    ...
    return SequenceRiskRequestHandler
