...
from courseflow_media_intelligence_service.service import MediaIntelligenceService
...
def handler_for(service: MediaIntelligenceService) -> type[BaseHTTPRequestHandler]:
    class MediaIntelligenceRequestHandler(BaseHTTPRequestHandler):
        server_version = "CourseFlowMediaIntelligence/0.1"
    ...
    return MediaIntelligenceRequestHandler
