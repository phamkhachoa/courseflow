...
The data foundation must be planned around enterprise operating outcomes, not around a single LMS
...
Future products should enter through `enterprise-df product-scaffold` or an equivalent reviewed
