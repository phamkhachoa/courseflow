...
Approved Bronze data product contracts live under `df/contracts/data-products`. The physical Iceberg
table naming and partition rules are defined in `df/platform/lakehouse/iceberg-table-standards.md`.
...
- Its source is listed in `df/platform/ingestion/source-systems.md` or the next product-specific
  source registry.
