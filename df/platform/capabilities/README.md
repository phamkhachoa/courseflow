...
`platform/capabilities/` is the architecture-as-code view of the enterprise data foundation. It
...
```bash
PYTHONPATH=src python -m enterprise_df.cli capability-maturity-report \
  --root . \
  --phase P0 \
