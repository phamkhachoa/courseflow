...
from enterprise_df.catalog_publish import build_catalog_publish_manifest, write_catalog_publish_manifest
...
def build_publish_inputs(tmp_path: Path) -> tuple[Path, Path, Path]:
    ...
    write_openlineage_events(
        catalog_path,
        openlineage_path,
        namespace="enterprise-df://prod",
        producer="https://enterprise-df.local/openlineage-export",
    )
