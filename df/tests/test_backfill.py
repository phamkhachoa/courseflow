...
def build_backfill_artifacts(tmp_path: Path, *, snapshot_environment: str = "staging") -> dict[str, Path]:
    ...
    ledger = write_offset_ledger_report(
        ...
        table_metadata_uri="s3://df-staging-lakehouse/warehouse/bronze/events_benefit_settled/metadata/00001.metadata.json",
...
def snapshot_metadata_entry(
    *,
    ...
    return {
        ...
        "metadata_uri": f"s3://df-staging-lakehouse/warehouse/{layer}/{table_name}/metadata/00001.metadata.json",
        "metadata_hash": "sha256:2222222222222222222222222222222222222222222222222222222222222222",
        "manifest_list_uri": f"s3://df-staging-lakehouse/warehouse/{layer}/{table_name}/metadata/snap-00001.avro",
