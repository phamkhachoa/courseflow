...
from enterprise_df.catalog import canonical_json, load_json
...
PRODUCT_ID = "enterprise-data-foundation"
        ...
        rows.append(
            {
                ...
                "freshness_status": "UNKNOWN" if not release_covered else ("GREEN" if release_passed else "RED"),
                ...
                "release_gate_status": "PASSED" if release_passed else ("FAILED" if release_covered else "MISSING"),
